...
class ExoVideo extends Component {
  ...
  render() {
    ...
    let uri = source.uri;
    let runOnLoad = (source.runOnLoad === undefined || source.runOnLoad === null) ? true : source.runOnLoad;
    if (uri && uri.match(/^\//)) {
      uri = 'file://' + uri;
    }
    ...
    if (resizeMode === VideoResizeMode.stretch) {
      nativeResizeMode = NativeModules.UIManager.ExoVideo.Constants.ScaleToFill;
    } else if (resizeMode === VideoResizeMode.contain) {
      nativeResizeMode = NativeModules.UIManager.ExoVideo.Constants.ScaleAspectFit;
    } else if (resizeMode === VideoResizeMode.cover) {
      nativeResizeMode = NativeModules.UIManager.ExoVideo.Constants.ScaleAspectFill;
    } else {
      nativeResizeMode = NativeModules.UIManager.ExoVideo.Constants.ScaleNone;
    }
...
const ExoVideoView = requireNativeComponent('ExoVideo', ExoVideo, {
  nativeOnly: {
    src: true,
    seek: true
  },
